# -*- coding: utf-8 -*-
"""CV_Match_(2)_(5).ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1r_3Pdz3IjSw3ZIXoZh3gOhRNjn9c70rW
"""
...
# !unzip /content/drive/MyDrive/Test_CV.zip
...
# import Image
# import pytesseract
# print(pytesseract.image_to_string(image.open('/content/drive/MyDrive/CV_BELLAGH_Othmane(1).jpg')))
...
def Recommandation_CV(folder,path_offre, deb, fin):
  ...
  return df.sort_values(by=["Score(en %)"], ascending = False)
...
# pdf_path = '/content/drive/MyDrive/Tested/CV_Boris_Kenne.pdf'
# # #docx_path = '/content/drive/MyDrive/TrackerCV/Abdoulaye Barro  CV updated.docx'
# text_pdf = extract_text_from_pdf(pdf_path)
# text_pdf
# txt = extract_experience(text_pdf, deb, fin)
# #txt
# text = transform(txt)
# txt = Convetir(txt)
# txt
#txt = format_date(txt)
#txt = [w for w in txt if w not in ]
#txt = ' '.join(txt)
# year_experience(txt)
#txt

# Score(text_pdf, job_description)

# folder = '/home/abdoulaye/Desktop/App_recommandation/CV_folder/'
# path_offre = "/home/abdoulaye/Desktop/App_recommandation/Offre_d'emploi.docx"
# Recommandation_CV(folder, path_offre, deb, fin)
